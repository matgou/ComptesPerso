		...
		<div class="modal-content">
			<div class="modal-header modal-danger">
				...
				<h4 class="modal-title">
					<i class="glyphicon glyphicon-fire"></i> Oup's une erreur est
					survenue !
				</h4>
			</div>
...
<div ng-controller="editModalController">
...
<script
	src="<%=request.getContextPath()%>/js/extensions/dt_timepicker.js"></script>
<script
...
<!-- Controllers -->
<script
	src="<%=request.getContextPath()%>/js/controllers/accountController.js"></script>
<script
	src="<%=request.getContextPath()%>/js/controllers/categoryController.js"></script>
<script
...
<script
	src="<%=request.getContextPath()%>/js/controllers/operationController.js"></script>
<script
	src="<%=request.getContextPath()%>/js/controllers/thirdPartyController.js"></script>
