...
<base
	href='${req.scheme}://${fn:substring(url, fn:indexOf(url, ":")+3, fn:length(url) - fn:length(uri))}${req.contextPath}/' />
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li ng-class="{'active': $route.current.activetab == 'dashboard'}"><a
						href="#!/">Synthèse</a></li>
					<li ng-class="{'active': $route.current.activetab == 'operation'}"><a
						href="#!/operations">Opérations</a></li>
					<li ng-class="{'active': $route.current.activetab == 'deadline'}"><a
						href="#">Echéances</a></li>
					<li ng-class="{'active': $route.current.activetab == 'thirdParty'}"><a
						href="#!/thirdParties">Tiers</a></li>
				</ul>
			</div>